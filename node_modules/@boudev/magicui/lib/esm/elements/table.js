...
import { RenderCompleteEvent } from "../events/index.js";
export class TableMagicElement extends MagicElement {
    constructor() {
        super(...arguments);
        this.element = null;
        this.links = new Map();
    ...
    render(data) {
                ...
                if (data[i]["id"] != undefined) {
                    ...
                    if (this.rowEvent != undefined) {
                        tr.addEventListener(this.rowEvent.event, (event) => {
                            this.rowEvent?.handler(tr.id, new ViewModel());
                        });
                    }
                }
                tr.appendChild(td);
        ...
        window.dispatchEvent(new RenderCompleteEvent(this));
    }
